...
def upgrade() -> None:
    ...
    op.create_foreign_key(None, 'remarks', 'teachers', ['teacher_id'], ['id'], ondelete='SET NULL')
    op.drop_constraint('results_subject_id_fkey', 'results', type_='foreignkey')
    op.create_foreign_key(None, 'results', 'subjects', ['subject_id'], ['id'], ondelete='SET NULL')
...
def downgrade() -> None:
    ...
    op.create_foreign_key('results_subject_id_fkey', 'results', 'subjects', ['subject_id'], ['id'])
    op.drop_constraint(None, 'remarks', type_='foreignkey')
    op.create_foreign_key('remarks_teacher_id_fkey', 'remarks', 'teachers', ['teacher_id'], ['id'])
