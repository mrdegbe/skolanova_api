...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_attendance_academic_year_id"),
        "attendance",
        ["academic_year_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_attendance_class_id"), "attendance", ["class_id"], unique=False
    )
    op.create_index(op.f("ix_attendance_date"), "attendance", ["date"], unique=False)
    op.create_index(op.f("ix_attendance_id"), "attendance", ["id"], unique=False)
    op.create_index(
        op.f("ix_attendance_marked_by"), "attendance", ["marked_by"], unique=False
    )
    op.create_index(
        op.f("ix_attendance_student_id"), "attendance", ["student_id"], unique=False
    )
    op.create_index(
        op.f("ix_attendance_tenant_id"), "attendance", ["tenant_id"], unique=False
    )
    op.create_foreign_key(
        None, "attendance", "tenants", ["tenant_id"], ["id"], ondelete="CASCADE"
    )
    op.add_column(
        "class_subject_teacher", sa.Column("tenant_id", sa.UUID(), nullable=True)
    )
    op.create_index(
        op.f("ix_class_subject_teacher_tenant_id"),
    ...
    op.create_index(
        op.f("ix_classes_tenant_id"), "classes", ["tenant_id"], unique=False
    )
    op.create_foreign_key(
        None, "classes", "tenants", ["tenant_id"], ["id"], ondelete="CASCADE"
    )
    op.add_column("remarks", sa.Column("tenant_id", sa.UUID(), nullable=True))
    op.create_index(
        op.f("ix_remarks_tenant_id"), "remarks", ["tenant_id"], unique=False
    )
    op.create_foreign_key(
        None, "remarks", "tenants", ["tenant_id"], ["id"], ondelete="CASCADE"
    )
    op.add_column("results", sa.Column("tenant_id", sa.UUID(), nullable=True))
    op.create_index(
        op.f("ix_results_tenant_id"), "results", ["tenant_id"], unique=False
    )
    op.create_foreign_key(
        None, "results", "tenants", ["tenant_id"], ["id"], ondelete="CASCADE"
    )
    ...
    op.create_foreign_key(
        None, "students", "tenants", ["tenant_id"], ["id"], ondelete="CASCADE"
    )
    op.add_column("teachers", sa.Column("tenant_id", sa.UUID(), nullable=True))
    op.create_index(
        op.f("ix_teachers_tenant_id"), "teachers", ["tenant_id"], unique=False
    )
    op.create_foreign_key(
        None, "teachers", "tenants", ["tenant_id"], ["id"], ondelete="CASCADE"
    )
...
def downgrade() -> None:
    ...
    op.drop_index(
        op.f("ix_class_subject_teacher_tenant_id"), table_name="class_subject_teacher"
    )
    ...
    op.create_index(
        "ix_attendance_marked_by", "attendance", ["marked_by"], unique=False
    )
